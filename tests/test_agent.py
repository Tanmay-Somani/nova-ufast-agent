...
from nova_ufast_agent import agent as loop
from nova_ufast_agent import model
from nova_ufast_agent.browser import StalePage, browser_operation, fingerprint
...
def test_observation_is_one_atomic_browser_read(monkeypatch):
    import nova_ufast_agent.browser as browser
